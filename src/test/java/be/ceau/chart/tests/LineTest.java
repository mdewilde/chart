...
public class LineTest extends ChartTest {
	 ...
	 * <a href="http://www.chartjs.org/docs/#line-chart-example-usage">Chart.js </a>
	 * web site
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Create the example chart found at <a href=
	 * "http://www.chartjs.org/docs/#line-chart-scatter-line-charts">Chart.js </a>
	 * web site
	 * 
	 * @throws IOException
	 */
